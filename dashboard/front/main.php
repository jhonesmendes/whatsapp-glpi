...
<head>
   ...
   <!-- <link href="less/style.less" rel="stylesheet"  title="lessCss" id="lessCss"> -->
	...
	<link href="css/home-modern.css" rel="stylesheet" type="text/css" />
</head>
...
<!-- <div id="pad-wrapper"> -->
	<?php 
			...
			// Open_basedir-safe: não consultar arquivos do sistema (/etc, /usr/bin).
			// A área de gráficos usa 100% da largura e o bloco Server Info foi removido.
			$width_os = '100%';
	?>
      ...
      <p id="choices" style=" margin-right: 20px; margin-top: 5px; text-align:right; width:<?php echo $width_os; ?>;"></p>	  	
		<div class="demo-container" style="margin-bottom:10px;">								
			<div id="graflinhas1" class="demo-placeholder" style="float:left; width: <?php echo $width_os; ?> ;"></div>
					...
					<!-- Server Info removido: evita warnings de open_basedir ao acessar arquivos do sistema. -->
		</div>
	</div>
	   <?php 
